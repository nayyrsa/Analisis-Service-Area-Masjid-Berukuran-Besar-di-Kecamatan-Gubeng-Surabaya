...
map.getView().fit([12550566.498543, -815547.495428, 12554395.422546, -810669.686285], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Analisis Service Area Masjid Berukuran Besar di Kecamatan Gubeng, Surabaya</h2>';
        return titleElement;
    })(),
